# Workflow mockup — source of truth
...
```
components/home/workflow/
  WorkflowMockup.astro          the nine story steps, stacked as layers
  common/                       ← lib/common/widgets — shared across screens
  screens/analyze/              ← lib/src/screens/analyze
  ...
  screens/list/                 ← lib/src/screens/list
    Lists.astro                   step 7
    ListDetails.astro             steps 8 and 9 (`compare`)
    widgets/
  screens/share-management/     ← lib/src/screens/share_management
    ShareModal.astro              step 10
  story/                        narration — no app equivalent
    StoryStep.astro  WorkflowCard.astro  WorkflowPointer.astro
